...
<body>
    ...
    <?php
        ...
        if(isset($_POST["update"])){
            extract($_POST);
            echo "UPDATE  persons2 SET Lastname='$lname', FirstName= '$fname', Address='$address', city_name='$city', phone='$phone', dob='$dob' WHERE PersonID='$id'" ;
           $sql = "UPDATE  persons2 SET Lastname='$lname', FirstName= '$fname', Address='$address', city_name='$city', phone='$phone', dob='$dob' WHERE PersonID='$id'" ;
        //    echo $sql;
            $db->query($sql);
