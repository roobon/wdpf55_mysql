            ...
            <?php  // step: 04  show the (record / row) as it is form database in a dynamic way
                ...
                while($row = $result -> fetch_object()){ ?>
                    ...
                    <tr>
                        ...
                        <!-- for action effect in field or for dynamic you have to use php syntax (?id = <?php  echo $row -> student_id ?>) and for alert you need to use javascript syntax -->
