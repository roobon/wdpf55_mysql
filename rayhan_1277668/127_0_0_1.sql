...
-- Database: `idb_bisew`
--
CREATE DATABASE IF NOT EXISTS `idb_bisew` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `idb_bisew`;
...
INSERT INTO `gamers` (`Id`, `Name`, `Gender`, `Email`) VALUES
(1, 'Abul Kashem', 'Male', 'Abul@kashem.com'),
(2, 'Hosne Ara', 'Female', 'hosne@ara.com');
...
('root', '[{\"db\":\"php_oop_crud\",\"table\":\"members\"}]');
...
('root', '2023-07-17 06:41:25', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":193}');
...
--
CREATE DATABASE IF NOT EXISTS `php_oop_crud` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `php_oop_crud`;
...
(12, 'Masum', 'Male', '2023-08-03', 'masum@gmail.com', 55, 'jatrabari', 'coding'),
(13, 'Alauddin', 'Male', '2010-01-23', 'ala@uddin.com', 55, 'very near', 'walking'),
(14, 'ALAUDDIN2', 'Male', '2023-08-03', 'alauddin@222.com', 0, 'laskjfl;sadjf;lkjfaslksd;fjla', 'cricket,footbal');
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `after_students_insert` AFTER INSERT ON `students` FOR EACH ROW INSERT INTO students_audit
 SET action = 'insert',
     student_id = NEW.id,
...
(1, 12, 'Masum', 'insert', '2023-08-23 10:14:55'),
(2, 12, 'Masum', 'update', '2023-08-23 10:43:38'),
(3, 11, 'Abdur Rahim', 'update', '2023-08-23 10:48:13'),
(4, 11, 'Abdur Rahim', 'delete', '2023-08-23 10:48:13'),
(5, 11, 'Abdur Rahim mia', 'delete', '2023-08-23 10:49:33'),
(6, 13, 'Alauddin', 'insert', '2023-08-26 10:58:23'),
(7, 14, 'ALAUDDIN2', 'insert', '2023-08-26 11:11:29');
...
-- Database: `tspdata`
--
CREATE DATABASE IF NOT EXISTS `tspdata` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tspdata`;
...
INSERT INTO `orders` (`OrderID`, `ProductID`, `ProductAmount`) VALUES
(0, 5, 100),
(1, 5, 100),
(2, 5, 1),
(4, 3, 1);
...
--
ALTER TABLE `products`
  MODIFY `ProductID` tinyint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- Database: `wdpf55_sample`
--
CREATE DATABASE IF NOT EXISTS `wdpf55_sample` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `wdpf55_sample`;
...
,`phone` varchar(50)
,`city` varchar(50)
,`TOTAL Orders` decimal(32,0)
,`productCode` varchar(15)
,`productName` varchar(70)
,`Total Price` decimal(42,2)
);
...
(420, 'Abul', 'azad', '', 'abul@kalam.com', '', 0, 'superman'),
(1000, 'Ahmed', 'Masum', 'x5800', 'dmurphy@classicmodelcars.com', '1', 0, 'president'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `customer_orders`  AS SELECT `customers`.`customerNumber` AS `customerNumber`, `customers`.`customerName` AS `customerName`, `customers`.`phone` AS `phone`, `customers`.`city` AS `city`, sum(`orderdetails`.`quantityOrdered`) AS `TOTAL Orders`, `orderdetails`.`productCode` AS `productCode`, `products`.`productName` AS `productName`, sum(`orderdetails`.`quantityOrdered` * `orderdetails`.`priceEach`) AS `Total Price` FROM ((`customers` join `orderdetails`) join `products`) GROUP BY `customers`.`customerNumber``customerNumber`  ;
...
-- Database: `wdpf_55`
--
CREATE DATABASE IF NOT EXISTS `wdpf_55` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wdpf_55`;
...
INSERT INTO `persons` (`PersonID`, `Address`, `City`, `email_address`, `phone`, `DateOfBirth`, `firstName`, `Gender`) VALUES
(4, ' asdsadasd ', 'Dhaka', 'asdasd@sasd.com', 1055, '0000-00-00', 'asad mia ', ''),
(5, '  Bangladesh  ', 'Dhaka', 'abul@kashem.com', 1424200, '2023-08-17', 'Abul Kashem updated', ''),
(17, '   asdasdasdsad   ', 'Chittagong', 'ala@vala.com', 22222, '2023-08-02', 'ALAUDDIN updated', ''),
(21, 'Asad Gate', 'Dhaka', 'asad@gate.com', 20, '2023-08-17', 'Asad', ''),
(24, 'taststsst', 'sylhet', 'tasty@treat.com', 20, '0000-00-00', 'test2', ''),
(25, 'asadasdas', 'rajshahi', 'helo@gelo.com', 20, '2023-08-03', 'helo', ''),
(26, 'asasdasd', 'khulna', 'abc@gmail.com', 555, '2023-08-17', 'rojoni', 'Female');
...
INSERT INTO `persons2` (`PersonID`, `Address`, `City`, `email_address`, `phone`, `DateOfBirth`, `firstName`) VALUES
(4, 'asdsadasd', 'Dhakaasdsad', 'asdasd', 1055, '0000-00-00 00:00:00', 'asdasd'),
(5, '  Bangladesh  ', 'Dhaka', 'abul@kashem.com', 1424200, '2023-08-16 18:00:00', 'Abul Kashem updated'),
(17, '   asdasdasdsad   ', 'Chittagong', 'ala@vala.com', 22222, '2023-08-01 18:00:00', 'ALAUDDIN updated'),
(18, 'asdasd', 'Chittagong', 'asdasdasd@gmail.com', 20, '0000-00-00 00:00:00', 'asdsad'),
(21, 'Asad Gate', 'Dhaka', 'asad@gate.com', 20, '2023-08-16 18:00:00', 'Asad'),
(24, 'taststsst', 'sylhet', 'tasty@treat.com', 20, '0000-00-00 00:00:00', 'test2');
...
INSERT INTO `user1` (`id`, `name`, `address`, `phone`, `dob`, `email`) VALUES
(1, 'Abul ', 'India, Indira Gandhi Road', '0156541695', '1966-05-03', 0),
(2, 'Kalam ', 'Jatrabari', '0156541695', '1996-05-03', 0),
(3, 'Azad', 'Jatrabari', '0156541695', '1996-05-03', 0);
...
(1, 'Masum Ahmed', 'masum@gmail.com', '5229a1b7271ec1644823ab383fad288bb68f58ef'),
(2, 'abc', 'abc@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b');
...
ALTER TABLE `persons2`
  ...
  ADD KEY `idx_lastname` (`firstName`);
