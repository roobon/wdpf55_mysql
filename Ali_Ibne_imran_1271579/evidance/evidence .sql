...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2023 at 08:25 AM
...
(1, 'nokia', 'koria', '1254786526'),
(2, 'apple', 'usa', '7857257'),
(3, 'samsung', 'koria', '7375'),
(4, 'Xioami', 'chaina', '75242'),
(5, 'oppo', 'india', '237654');
...
--
DELIMITER $$
CREATE TRIGGER `after_manufacturer_delete` AFTER DELETE ON `manufacturer` FOR EACH ROW DELETE FROM product WHERE m_id=OLD.m_id
$$
DELIMITER ;
...
(27, 'iphone_14', 25000, 2),
(28, 'iphone_15', 35000, 2),
(29, 'S21', 20000, 3),
(30, 'S32', 26000, 3),
(31, 'N52', 30000, 2),
(32, 'N45', 15000, 2),
